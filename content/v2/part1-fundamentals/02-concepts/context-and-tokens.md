...
## Understanding Context and Tokens in LLMs
...
- **Context Window:** LLMs have a fixed context window size, which is the maximum number of tokens the model can consider at once.
  - **Llama 3.2** has a context window of **128,000 tokens** (128K) - significantly larger than earlier models!
...
A simple tool to visualize tokenization is available at [tiktokenizer.vercel.app](https://tiktokenizer.vercel.app/?model=meta-llama%2FMeta-Llama-3-8B).

{{< callout type="info" >}}
**Try it yourself:** Paste a sentence into the tokenizer tool and see how it gets broken down into tokens. Notice how common words are often single tokens, while rare or complex words might be split into multiple tokens.
{{< /callout >}}

Note: This tool is for demonstration purposes and may not have all the models we use, but it gives you a good sense of how tokenization works.
