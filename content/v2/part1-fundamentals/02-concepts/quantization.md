...
- **Resource Constraints:** LLMs can be enormous, making them difficult to deploy on devices with limited resources like laptops or personal computers.
- **Energy Efficiency:** Smaller models consume less power, which is crucial for battery-powered devices and reducing environmental impact.
...
These are some of the quantization labels used in Ollama models. Understanding these helps you choose the right model size for your hardware:
...
{{< callout type="info" >}}
**For this workshop**, we recommend using the default Llama 3.2 model (Q4_K_M quantization), which provides a good balance between size and quality. If you have more RAM available (16 GB+), you can try Q5_K_M for even better quality.
{{< /callout >}}

**Reference:** [Ollama Quantization Discussion](https://github.com/ollama/ollama/issues/1388#issuecomment-1841890505)
